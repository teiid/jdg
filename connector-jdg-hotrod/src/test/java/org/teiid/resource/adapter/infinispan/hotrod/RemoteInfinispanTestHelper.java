...
public class RemoteInfinispanTestHelper {
	public static final String CONFIG_FILE = "infinispan_personcache_config.xml";

	public static final String TEST_CACHE_NAME = "test";
	public static final String PERSON_CACHE_NAME = PersonCacheSource.PERSON_CACHE_NAME;
	public static final Class<?> PERSON_CLASS = Person.class;
	public static final String PKEY_COLUMN = "id";
	
	public static final int PORT = 11312;
...
//				System.out.println("==== Creating JDG Hot Rod Server.... ====");
				...
				CACHEMANAGER.startCache(AllTypesCacheSource.ALLTYPES_CACHE_NAME);
			...
			if (KeyStoreFile != null) {
			     bldr.ssl().enable().keyStoreFileName(KeyStoreFile)
			...
			HOTRODSERVER.start(config, CACHEMANAGER);
