...
public final class DSLSearch implements SearchType  {
	...
	private static Object performSearch(String columnNameInSource,
			Object value, InfinispanConnectionImpl conn)  throws TranslatorException  {	
		
		@SuppressWarnings("rawtypes")
		QueryBuilder qb = conn.getQueryBuilder("table");
	...
	public List<Object> performSearch(ObjectVisitor visitor,
		...
		try {
			return performSearch(visitor, (InfinispanConnectionImpl) conn);
		} finally {
			conn = null;
		}
	...
	private static List<Object> performSearch(ObjectVisitor visitor, InfinispanConnectionImpl conn) throws TranslatorException  {			
	    ...
	    FilterConditionContextQueryBuilder fcc = buildQueryFromWhereClause(where, qb, null);
		...
		if (visitor.getLimit() > 0) {
	    	query = query.maxResults(visitor.getLimit());
	    }	    
		results = query.list();
	...
	private static FilterConditionContextQueryBuilder buildQueryFromWhereClause(Condition criteria, @SuppressWarnings("rawtypes") QueryBuilder queryBuilder, FilterConditionBeginContext fcbc)
			throws TranslatorException {

		if (criteria == null) return null;
		FilterConditionContextQueryBuilder fcc = null;
	...
	@SuppressWarnings("rawtypes")
	private static FilterConditionContextQueryBuilder visit(Comparison obj, QueryBuilder queryBuilder, FilterConditionBeginContext fcbc) throws TranslatorException {
	...
	private static FilterConditionContextQueryBuilder visit(In obj, QueryBuilder queryBuilder, FilterConditionBeginContext fcbc) throws TranslatorException {
	...
	@SuppressWarnings("rawtypes")
	private static FilterConditionContextQueryBuilder visit(Like obj, QueryBuilder queryBuilder, FilterConditionBeginContext fcbc) throws TranslatorException {
		LogManager.logTrace(LogConstants.CTX_CONNECTOR,
	...
	@SuppressWarnings("rawtypes")
	private static FilterConditionContextQueryBuilder visit(IsNull obj, QueryBuilder queryBuilder, FilterConditionBeginContext fcbc)  {
		LogManager.logTrace(LogConstants.CTX_CONNECTOR,
