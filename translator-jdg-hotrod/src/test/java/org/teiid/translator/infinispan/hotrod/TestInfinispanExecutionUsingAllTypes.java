...
public class TestInfinispanExecutionUsingAllTypes {
	...
	private static TranslationUtility translationUtility =  AllTypesSchemaVDBUtility.createAllTypesMetadata();
	private static RuntimeMetadata RUNTIME_METADATA = translationUtility.createRuntimeMetadata();

			//AllTypesSchemaVDBUtility.TRANSLATION_UTILITY;
...
//			}
		...
		return (ObjectExecution) translator.createExecution(command, Mockito.mock(ExecutionContext.class), RUNTIME_METADATA, CONNECTION);
	}
}
