...
public class InfinispanHotRodExecutionFactory extends ObjectExecutionFactory {
	...
	private MetadataProcessor<ObjectConnection> processor;
	...
	/**
	 * Not Enabled for resource adapters in 8.12
	 * @param connection 
...
//
//		this.processor = ( (InfinispanHotRodConnection) connection).getMetadataProcessor();
//		
